            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="price" class="col-md-4 col-form-label text-md-end">{{ __('Offer Price') }}</label>

                            <div class="col-md-6">
                                <input id="offer_price" type="text" class="form-control @error('offer_price') is-invalid @enderror" name="offer_price" autocomplete="offer_price">
